...
import { Upload, Loader2, Plus, X, Sparkles, Heart } from "lucide-react";
  ...
  return (
    <div className="space-y-5 max-w-md mx-auto px-3 py-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Upload reference photos and define their personality to bring them to life.</p>
      </div>
        ...
        <CardContent className="p-4 space-y-3">
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Describe their appearance in detail — hair color, eye color, build, distinguishing features..."
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="e.g. warm, caring, playful, a bit shy but opens up quickly, loves cooking..."
